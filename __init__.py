...
try:
    from .CFG.cfg_nodes import NODE_CLASS_MAPPINGS as CFG_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as CFG_NODE_DISPLAY_NAME_MAPPINGS
except Exception as e:
    print(f"CFG nodes not available due to error in importing them: {e}")
    CFG_NODE_CLASS_MAPPINGS = {}
    CFG_NODE_DISPLAY_NAME_MAPPINGS = {}    
...
NODE_CLASS_MAPPINGS.update(CFG_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(CFG_NODE_DISPLAY_NAME_MAPPINGS)
