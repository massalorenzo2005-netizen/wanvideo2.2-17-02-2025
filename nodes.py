...
class WanVideoFreeInitArgs:
    ...
    def INPUT_TYPES(s):
        return {"required": {
                ...
                "freeinit_method": (["butterworth", "ideal", "gaussian", "none"], {"default": "butterworth", "tooltip": "Frequency filter type"}),
...
class WanVideoSampler:
    ...
    def process(self, model, image_embeds, shift, steps, cfg, seed, scheduler, riflex_freq_index, text_embeds=None,
        ...
        experimental_args=None, sigmas=None, unianimate_poses=None, fantasytalking_embeds=None, uni3c_embeds=None, freeinit_args=None):
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "WanVideoFreeInitArgs": "WanVideo FreeInit Args",
    }
